# Django settings for manchester_survey project.
...
ROOT_URLCONF = 'manchester_survey.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'manchester_survey.wsgi.application'
...
TEMPLATE_CONTEXT_PROCESSORS = global_settings.TEMPLATE_CONTEXT_PROCESSORS + (
    ...
    "manchester_survey.context_processors.add_settings",
)
