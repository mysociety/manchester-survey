...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ct, created = orm['contenttypes.ContentType'].objects.get_or_create(
            model='item', app_label='survey')
        perm, created = orm['auth.permission'].objects.get_or_create(
            content_type=ct, codename='can_export', defaults=dict(name=u'User can export the Survey data to CSV'))
    ...
    complete_apps = ['contenttypes', 'auth', 'survey']
    symmetrical = True
