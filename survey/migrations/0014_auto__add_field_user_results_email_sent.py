...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.results_email_sent'
        db.add_column(u'survey_user', 'results_email_sent',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.results_email_sent'
        db.delete_column(u'survey_user', 'results_email_sent')
