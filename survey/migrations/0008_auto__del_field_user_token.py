...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'User.token'
        db.delete_column(u'survey_user', 'token')


    def backwards(self, orm):
        # Adding field 'User.token'
        db.add_column(u'survey_user', 'token',
                      self.gf('django.db.models.fields.TextField')(unique=True, null=True, db_index=True),
                      keep_default=False)
